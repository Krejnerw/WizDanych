...
ax2.bar3d(x, y, bottom, width, depth, top, shade = True , alpha = 0.5, color = 'y')
ax2.set_title('Wykres przeswitujacy')
ax3.bar3d(x, y, bottom, width, depth, top, shade = False)
ax3.set_title('Wykres nie zacieniony')
ax4.bar3d(x, y, bottom, width, depth, top, shade = False,color = 'pink', edgecolor=['black','r','y'])
ax4.set_title('Wykres z krawiedziami')
ax5.bar3d(x, y, bottom, width, depth, top, shade = True, color = 'g', zsort='max')
